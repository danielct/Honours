...
solverOld = Simulator.GPESolver(grid.getSpatialGrid(), grid.getkGrid(),
                             N_THREADS=3)
print "Making pump"
#
...
gpeEq = SimulatorNew.GPECoupled(oldParams, pumpFunction)
solverNew = SimulatorNew.Solver(gpeEq, grid)
