...
%Coefficients in the ODGPE: (normalised for  m_LP=10^{-3} me)
 g=393.7026; %LP polariton-polariton scattering
 gR=0*g; %LP interaction with incoherent reservoir
 GammaC=1; GammaR=4*GammaC; % LP relaxation rate & %reservoir polaritons relaxation rate
 R=1.312342; %stimulated scattering rate
...
Pump = P0 * Pth * exp(-0.5 * (x.^2 + y.^2) / sigma^2);
